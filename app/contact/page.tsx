...
export default function Contact() {
    ...
    <div className="text-center">
        ...
        <p className="text-white-400 white:text-gray-300">
    ...
    <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 w-full max-w-4xl">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md p-6 hover:shadow-xl transition-shadow duration-300">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">LinkedIn</h2>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md p-6 hover:shadow-xl transition-shadow duration-300">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Instagram</h2>
